...
class BillClass:
    def __init__(self, root):
        ...
        lbl_search1=Label(ProductFrame2,text="Search Product | By Name ",font=("times new roman",15,"bold"),bg="white",fg="green").place(x=2,y=5)
        ...
        txt_cname=Entry(CustomerFrame,textvariable=self.var_cname,font=("times new roman",13),bg="lightyellow").place(x=80,y=35,width=180)
        ...
        txt_cal_input=Entry(Cal_Frame,textvariable=self.var_cal_input,font=('arial',15,'bold'),width=21,bd=10,relief=GROOVE,state='readonly',justify=RIGHT).grid(row=0,columnspan=4)
        ...
        btn_c=Button(Cal_Frame,text='c',font=('arial',15,'bold'),command=self.clear_cal,bd=5,width=4,pady=11,cursor='hand2').grid(row=4,column=1)
        btn_eq=Button(Cal_Frame,text='=',font=('arial',15,'bold'),command=self.perform_cal,bd=5,width=4,pady=11,cursor='hand2').grid(row=4,column=2)
        ...
        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#145656",fg="white").pack(side=TOP,fill=X)
        ...
        #=================================================Footer=================================================
        footer=Label(self.root,text="IMS-Inventory Management System | Developed by Aakash Sharma \n For any Technical Issue Contact: 9468497114",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#================================================All Functions================================================
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            messagebox.showerror('Error',"Stock is not Available.",parent=self.root)
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tSHARMA-INVENTORY
Phone No. 9468497114,    Sangwari,Rewari-123401
{str("="*47)}   
 Customer Name: {self.var_cname.get()}
 Mobile Number: {self.var_contact.get()}
 Bill No. {str(self.invoice)}\t\t\tDate: {str(time.strftime("%d/%m/%Y"))}
{str("="*47)}
 Product Name \t\t\tQTY\tPrice
{str("="*47)}  
        '''
                    # {str("="*47)} means getting equal to(=) sign 47 times. 
