...
class productClass:
    def __init__(self, root):
        ...
        #====title====
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18),bg="#0f4d74",fg="white").pack(side=TOP,fill=X)
        ...
        #==========================buttons==========================
        btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",cursor="hand2",fg="white").place(x=10,y=400,width=100,height=40)
        btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",cursor="hand2",fg="white").place(x=120,y=400,width=100,height=40)
        btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",cursor="hand2",fg="white").place(x=230,y=400,width=100,height=40)
        btn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",cursor="hand2",fg="white").place(x=340,y=400,width=100,height=40)
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",cursor="hand2",fg="white").place(x=410,y=9,width=150,height=30)
        ...
        try:
            if self.var_pid.get()=="":
                ...
                if row == None:
                    ...
                    if op == True:
                        cur.execute("delete from product where pid=?",(self.var_emp_id.get(),))
                        con.commit()
