...
class salesClass:
    def __init__(self, root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15,"bold"),bg="lightgray",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        #================================================Images================================================
        self.bill_photo=Image.open("E:\Project\Inventory Management System\images\cat2.jpg")
...
#==============================================================================================================
    def show(self):
        ...
        #print(os.listdir('../INVENTORY MANAGEMENT SYSTEM')) bill1.txt, category.py
